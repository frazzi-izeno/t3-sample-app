...
app.get('/', function(req, res) {
    ...
    request(QOD_API_URL + '/daily', function(error, response, body) {
        if (error) {
            ...
            var quote = parsed.contents.quotes[0];
            quote.today = dateFormat(new Date(), "dddd, mmmm dS, yyyy");
...
// Background random quote poller
...
// Start background random quote fetcher
...
// Stop background random quote fetcher
